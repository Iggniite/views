...
export default function Proof({ video, isAdmin }) {
  ...
  async function addSchedule() {
    ...
    const formatted = new Date(`1970-01-01T${time}`).toLocaleTimeString("en-IN", {
      hour: "numeric",
      minute: "2-digit",
      hour12: true,
    });
    ...
    <div style={{ maxWidth: "900px", margin: "auto" }}>
      ...
      >
        ...
        {pending.map((p) => (
          ...
          >
            <div>
              <strong>Scheduled Screenshot</strong>
            </div>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <a href={`${BASE_URL}/proofs/${fileName}`} target="_blank" rel="noreferrer">
                  <button>👁 View</button>
                </a>
                ...
                {isAdmin && <button onClick={() => deleteProof(p.id)}>🗑</button>}
              </div>
            </div>
          );
        })}
